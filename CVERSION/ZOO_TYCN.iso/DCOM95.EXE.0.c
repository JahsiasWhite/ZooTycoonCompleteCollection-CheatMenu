...

{
  ...
  iVar5 = 0;
  while( true ) {
    psVar2 = FUN_01005988(param_2,(short)*pcVar4);
    if (psVar2 == (short *)0x0) {
      *param_1 = pcVar4;
      cVar1 = *pcVar4;
      for (; (psVar2 = FUN_01005988(param_2,(short)cVar1), psVar2 == (short *)0x0 &&
...
undefined4 FUN_010017f8(LPSTR param_1,LPSTR *param_2,undefined4 *param_3)

{
  ...
  if (local_214[0] == '\"') {
    ...
    psVar6 = (short *)&DAT_010012e4;
  }
  else {
    local_8 = (short *)local_214;
    psVar6 = (short *)&DAT_010012e0;
  }
  psVar6 = (short *)FUN_01001799((char **)&local_8,psVar6);
  iVar1 = FUN_01002096((LPCSTR)local_8);
  if (iVar1 == 0) {
    lstrcpyA(local_110,&DAT_0100ae84);
    FUN_010059ea(local_110,(LPCSTR)local_8);
  }
  else {
    lstrcpyA(local_110,(LPCSTR)local_8);
  }
  psVar2 = FUN_010059b8(local_8,0x2e);
  if ((psVar2 == (short *)0x0) || (iVar1 = lstrcmpiA((LPCSTR)psVar2,".INF"), iVar1 != 0)) {
    ...
    if ((psVar2 == (short *)0x0) || (iVar1 = lstrcmpiA((LPCSTR)psVar2,".BAT"), iVar1 != 0)) {
      local_c = (LPSTR)LocalAlloc(0x40,0x400);
      if (local_c != (LPSTR)0x0) {
        DVar4 = GetFileAttributesA(local_110);
        if ((DVar4 == 0xffffffff) || ((DVar4 & 0x10) != 0)) {
          lstrcpyA(local_614,param_1);
        }
        else {
          lstrcpyA(local_614,local_110);
          if ((psVar6 != (short *)0x0) && (*(char *)psVar6 != '\0')) {
            lstrcatA(local_614," ");
            lstrcatA(local_614,(LPCSTR)psVar6);
          }
        }
        FUN_01002631(local_614,local_c);
        goto LAB_01001aef;
      }
    }
    else {
      iVar1 = lstrlenA(local_110);
      iVar5 = lstrlenA(s_Command_com__c__s_0100a208);
      local_c = (LPSTR)LocalAlloc(0x40,iVar1 + 8 + iVar5);
      if (local_c != (LPSTR)0x0) {
        wsprintfA(local_c,s_Command_com__c__s_0100a208,local_110);
LAB_01001aef:
        *param_2 = local_c;
        return 1;
      }
    ...
    local_8 = psVar6;
    psVar6 = (short *)FUN_01001799((char **)&local_8,(short *)&DAT_010012d4);
    ...
    local_c = (LPSTR)LocalAlloc(0x40,0x200);
    if (local_c != (LPSTR)0x0) {
      pcVar3 = (char *)local_8;
      if (*(char *)local_8 == '\0') {
        pcVar3 = s_DefaultInstall_0100a0b8;
      }
      _DAT_0100b824 = GetPrivateProfileIntA(pcVar3,"Reboot",0,local_110);
      *param_3 = 1;
      DVar4 = GetPrivateProfileStringA("Version","AdvancedINF","",local_c,8,local_110);
      if (DVar4 == 0) {
        ...
        psVar6 = (short *)s_DefaultInstall_0100a0b8;
        if (*(char *)local_8 != '\0') {
          psVar6 = local_8;
        }
        wsprintfA(local_c,s_rundll32_exe__s_InstallHinfSecti_0100a018,pcVar3,psVar6,local_110);
      }
      else {
        ...
        lstrcpyA(param_1,(LPCSTR)psVar6);
        lstrcpyA(local_c,local_110);
      }
      goto LAB_01001aef;
    }
  }
  local_c = (LPSTR)0x0;
  FUN_01003c23((HWND)0x0,0x4b5,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
  return 0;
}



void FUN_01001b01(void)

{
  FUN_01003c23((HWND)0x0,0x521,"",(LPCSTR)0x0,0x40,0);
  return;
}
...

{
  ...
  if ((_DAT_0100b824 == 0) &&
     (bVar1 = FUN_0100220b(DAT_0100bc08,DAT_0100bc04), CONCAT31(extraout_var,bVar1) == 0)) {
    return 0xffffffff;
  }
  return 2;
}
...

{
  ...
  FUN_01003c23((HWND)0x0,UVar2,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
  return 0;
}



void FUN_01001bd5(byte param_1)

{
  ...
  if (iVar1 == 2) {
    if ((param_1 & 4) == 0) {
      iVar1 = FUN_01003c23((HWND)0x0,0x522,"",(LPCSTR)0x0,0x40,4);
    }
    else {
      iVar1 = 6;
    }
...

{
  ...
  *(undefined *)((int)puVar8 + 2) = 0;
  ...
  FUN_010059ea(&local_220,"advpack.dll");
  ...
  if (local_10 == 0) {
    ...
    if (DVar4 == 0) goto LAB_01001e03;
  }
  else {
    UVar3 = GetSystemDirectoryA(&local_11c,0x104);
    if (UVar3 != 0) {
      FUN_010059ea(&local_11c,"");
    }
  }
...
void FUN_01001f66(LPCSTR param_1)
      ...
      do {
        ...
        if ((local_248 & 0x10) == 0) {
          ...
          if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
              lstrcatA(local_108,local_21c);
              FUN_010059ea(local_108,"");
              FUN_01001f66(local_108);
            }
          }
        }
...
undefined4 FUN_01002096(LPCSTR param_1)
...

{
  ...
  if (UVar1 != 0) {
    FUN_010059ea(local_108,"wininit.ini");
...
DWORD FUN_0100212f(HKEY param_1,LPCSTR param_2)
...
DWORD FUN_01002180(HKEY param_1)
...
void FUN_010021d5(short param_1)

{
  if (param_1 == 0) {
    ...
    FUN_01002180((HKEY)s_System_CurrentControlSet_Control_0100a168);
  }
  else if (param_1 == 2) {
    FUN_0100212f((HKEY)s_System_CurrentControlSet_Control_0100a110,
...
bool FUN_0100220b(int param_1,short param_2)

{
  int iVar1;
  
  iVar1 = FUN_010021d5(param_2);
  return param_1 != iVar1;
}



uint FUN_01002222(LPCSTR param_1)
...
bool FUN_01002245(char *param_1)

{
  ...
  UVar1 = GetWindowsDirectoryA(local_108,0x104);
  if (UVar1 == 0) {
    FUN_01003c23((HWND)0x0,0x4f0,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
  }
...
LPSTR FUN_01002288(undefined4 param_1,LPSTR param_2)
...
bool FUN_010022a5(int param_1,int param_2,uint param_3,LPCSTR param_4)

{
  ...
  if (param_1 == 1) {
    ...
    UVar5 = 0x10;
    pCVar4 = (LPCSTR)0x0;
    pCVar1 = FUN_01002288((param_2 + param_3) / 1000,local_10);
    FUN_01003c23((HWND)0x0,0x4fa,pCVar1,pCVar4,UVar5,uVar6);
  }
  else if (param_1 == 4) {
    uVar6 = 5;
    UVar5 = 0x20;
    pCVar4 = (LPCSTR)0x0;
    pCVar1 = FUN_01002288((param_2 + param_3) / 1000,local_10);
    iVar2 = FUN_01003c23((HWND)0x0,0x4bd,pCVar1,pCVar4,UVar5,uVar6);
    cVar3 = '\x01' - (iVar2 != 4);
  }
  else if (param_1 == 2) {
    uVar6 = 0x104;
    UVar5 = 0x40;
    pCVar1 = FUN_01002288(param_3 / 1000,local_10);
    iVar2 = FUN_01003c23((HWND)0x0,0x4cc,pCVar1,param_4,UVar5,uVar6);
    if (iVar2 == 6) {
      DAT_0100b704 = 0;
      cVar3 = '\x01';
    }
...
undefined4 FUN_01002374(LPBYTE param_1,HKEY param_2,char *param_3)
...
LAB_0100244a:
  if (local_8 == 0) {
    FUN_010059ea((LPCSTR)lpData,pcVar2);
  }
  return 1;
}
...
undefined4 FUN_01002461(int param_1,LPBYTE param_2,HKEY param_3,int *param_4)

{
  ...
  if (0 < *(int *)(param_1 + 0x7c)) {
    ...
    do {
      ...
      iVar3 = FUN_01002374(param_2,param_3,
                           (char *)(*(int *)(param_1 + iVar2 + 0xbc + *(int *)(iVar2 + 0x80)) + 0x84
                                   + iVar2));
      if (iVar3 == 0) goto LAB_010025cd;
      ...
      if (local_1c == 0) {
        ...
        if ((BVar4 != 0) &&
          ...
          do {
            uVar5 = FUN_0100260a(*(uint *)((int)local_14 + 8),*(uint *)((int)local_14 + 0xc),
                                 puVar8[-4],puVar8[-3]);
            uVar6 = *puVar8;
            *(uint *)((int)local_34 + iVar3 + 8) = uVar5;
            uVar6 = FUN_0100260a(*(uint *)((int)local_14 + 8),*(uint *)((int)local_14 + 0xc),
                                 puVar8[-1],uVar6);
...
uint FUN_010025ed(uint param_1)
...
uint FUN_0100260a(uint param_1,uint param_2,uint param_3,uint param_4)
...
void FUN_01002631(LPCSTR param_1,LPSTR param_2)

{
  ...
  *param_2 = '\0';
  if ((param_1 != (LPCSTR)0x0) && (*param_1 != '\0')) {
    GetModuleFileNameA(DAT_0100b6dc,local_108,0x104);
    cVar1 = *param_1;
    while (cVar1 != '\0') {
      *param_2 = cVar1;
      if (*param_1 == '#') {
        param_1 = CharNextA(param_1);
        pCVar2 = CharUpperA((LPSTR)(int)*param_1);
        if ((char)pCVar2 == 'D') {
          FUN_01005a29(local_108);
          iVar3 = lstrlenA(local_108);
          if (local_108[iVar3 + -1] == '\\') {
            iVar3 = lstrlenA(local_108);
            local_108[iVar3 + -1] = '\0';
          }
        }
          ...
          pCVar2 = CharUpperA((LPSTR)(int)*param_1);
          if ((char)pCVar2 != 'E') {
            if (*param_1 == '#') goto LAB_01002705;
            goto LAB_0100270a;
          }
        }
        lstrcpyA(param_2,local_108);
        iVar3 = lstrlenA(local_108);
        param_2 = param_2 + iVar3;
      }
      else {
LAB_01002705:
        param_2 = CharNextA(param_2);
      }
LAB_0100270a:
      param_1 = CharNextA(param_1);
      cVar1 = *param_1;
...

{
  ...
  uExitCode = FUN_010027a0(pHVar3,uVar5,pcVar2);
...
undefined4 FUN_010027a0(HMODULE param_1,undefined4 param_2,char *param_3)

{
  ...
  iVar2 = 0;
  DAT_0100b704 = 0;
  iVar1 = FUN_010027ff(param_1,param_3);
  if (iVar1 != 0) {
    iVar2 = FUN_01002a37();
    thunk_FUN_0100490c();
  }
  if (((iVar2 != 0) && (DAT_0100aaba == '\0')) && ((_DAT_0100b6cc & 1) != 0)) {
    FUN_01001bd5((byte)_DAT_0100b6cc);
  }
...
undefined4 FUN_010027ff(HMODULE param_1,char *param_2)

{
  ...
  puVar4 = &DAT_0100aaa0;
  for (iVar3 = 0xca; iVar3 != 0; iVar3 = iVar3 + -1) {
    *puVar4 = 0;
    puVar4 = puVar4 + 1;
  }
  puVar4 = &DAT_0100b720;
  ...
  local_8 = (HGLOBAL)0x0;
  _DAT_0100b08c = 1;
  DVar2 = FUN_01003d7d("TITLE",(undefined4 *)&DAT_0100adf4,0x7f);
  if ((DVar2 == 0) || (0x80 < DVar2)) {
    ...
    DVar2 = FUN_01003d7d("EXTRACTOPT",(undefined4 *)&DAT_0100b6d4,4);
    if (DVar2 == 0) {
LAB_010028bc:
      FUN_01003c23((HWND)0x0,0x4b1,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
      DAT_0100b704 = 0x80070714;
      return 0;
    }
    if ((DAT_0100b6d4 & 0xc0) != 0) {
      DVar2 = FUN_01003d7d("INSTANCECHECK",local_10c,0x104);
      if (DVar2 == 0) goto LAB_010028bc;
      ...
      if ((DAT_0100aa80 != (HANDLE)0x0) && (DVar2 = GetLastError(), DVar2 == 0xb7)) {
        if ((DAT_0100b6d4 & 0x80) != 0) {
          FUN_01003c23((HWND)0x0,0x54b,&DAT_0100adf4,(LPCSTR)0x0,0x10,0);
LAB_01002931:
          CloseHandle(DAT_0100aa80);
          DAT_0100b704 = 0x800700b7;
          return 0;
        }
        iVar3 = FUN_01003c23((HWND)0x0,0x524,&DAT_0100adf4,(LPCSTR)0x0,0x20,4);
        if (iVar3 != 6) goto LAB_01002931;
      }
    }
    _DAT_0100b824 = 0;
    iVar3 = FUN_010051a5(param_2);
    if (iVar3 != 0) {
      if (DAT_0100aaba != '\0') {
        FUN_01001f66(&DAT_0100aaba);
        return 0;
      }
      ...
      bVar1 = FUN_0100310e((int)local_8);
      ...
      iVar3 = FUN_010058e6(DAT_0100b6dc,(LPCSTR)0x7d6,(HWND)0x0,FUN_0100170a,0x547,0x83e);
      if (iVar3 != 0x83d) {
        return 0;
      }
      return 1;
  ...
  FUN_01003c23((HWND)0x0,UVar5,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
  return 0;
}
...

{
  ...
  if (DAT_0100aab8 == 0) {
    if ((_DAT_0100aaa4 == 0) && (iVar2 = FUN_01004846(), iVar2 == 0)) {
      return 0;
    }
    if ((DAT_0100aab8 == 0) && (iVar2 = FUN_010033bc(), iVar2 == 0)) {
      return 0;
    }
  }
  iVar2 = FUN_010047bd();
  if ((iVar2 != 0) && (iVar2 = FUN_01004b8a(), iVar2 != 0)) {
    if ((_DAT_0100aaa4 == 0) &&
       ((_DAT_0100b6d0 == 0 && (bVar1 = FUN_0100562b(), CONCAT31(extraout_var,bVar1) == 0)))) {
      return 0;
    }
    BVar3 = SetCurrentDirectoryA(&DAT_0100ae84);
    if (BVar3 != 0) {
      if ((_DAT_0100aaac == 0) && (iVar2 = FUN_0100349b(), iVar2 == 0)) {
        return 0;
      }
      DAT_0100bc08 = FUN_010021d5(DAT_0100bc04);
      if (((_DAT_0100aaa4 == 0) && (_DAT_0100b6d0 == 0)) && (iVar2 = FUN_01003519(), iVar2 == 0)) {
        return 0;
      }
    ...
    FUN_01003c23((HWND)0x0,0x4bc,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
    DAT_0100b704 = FUN_010056b9();
  }
  return 0;
}
...

{
  ...
  if (((DAT_0100aaa0 != 0) && (_DAT_0100aaa4 == 0)) && (_DAT_0100b6d0 == 0)) {
    ...
    if ((DAT_0100b6d4 & 0x20) != 0) {
      FUN_01005a29(aCStack_104);
    }
    SetCurrentDirectoryA("..");
    FUN_01001f66(aCStack_104);
  }
...
void FUN_01002b27(HWND param_1,LONG param_2)
...
LRESULT FUN_01002b4b(HWND param_1,UINT param_2,WPARAM param_3,int param_4)
...
undefined4 FUN_01002b83(HWND param_1,int param_2,int param_3)
...
LAB_01002baf:
      ...
      FUN_01002b27(pHVar2,(LONG)pcVar3);
    }
    else {
      if (param_2 != 0x111) goto LAB_01002bec;
      if (param_3 == 6) {
        nResult = 1;
        goto LAB_01002baf;
      }
      if (param_3 == 7) goto LAB_01002bad;
    }
    uVar1 = 1;
  }
  return uVar1;
...
undefined4 FUN_01002c42(LPCSTR param_1)
...
undefined4 FUN_01002c72(HWND param_1,int param_2,int param_3)

{
  ...
  if (param_2 != 0x10) {
    ...
    if (param_3 == 1) {
      ...
      if ((UVar4 == 0) || (iVar2 = FUN_01002c42(&DAT_0100ae84), iVar2 == 0)) {
        pCVar8 = (LPCSTR)0x0;
        UVar4 = 0x4bf;
      }
      else {
        ...
        if (DVar5 == 0xffffffff) {
          iVar2 = FUN_01003c23(param_1,0x54a,&DAT_0100ae84,(LPCSTR)0x0,0x20,4);
          if (iVar2 != 6) {
            return 1;
          }
        ...
        FUN_010059ea(&DAT_0100ae84,"");
        iVar2 = FUN_01004e71(&DAT_0100ae84);
        if (iVar2 != 0) {
          if ((DAT_0100ae84 != '\\') || (uVar7 = 0, DAT_0100ae85 != '\\')) {
            uVar7 = 1;
          }
          bVar1 = FUN_01004f10(&DAT_0100ae84,uVar7,1);
...
LAB_01002e1b:
      FUN_01003c23(param_1,UVar4,pCVar8,(LPCSTR)0x0,0x10,0);
      return 1;
    }
    if (param_3 == 2) {
      EndDialog(param_1,0);
    ...
    if (iVar2 == 0) {
      FUN_01003c23(param_1,0x4b1,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
    }
    else {
      bVar1 = FUN_01003a23(param_1,&DAT_0100a670,&DAT_0100a360);
      if (CONCAT31(extraout_var,bVar1) == 0) {
        return 1;
      }
      ...
      FUN_01003c23(param_1,0x4c0,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
    }
  }
  EndDialog(param_1,0);
  return 1;
...
undefined4 FUN_01002e91(HWND param_1,int param_2,uint param_3)
...
undefined4 FUN_01002f20(HWND param_1,int param_2,int param_3)
  ...
  if (param_2 != 0x10) {
    if (param_2 != 0x102) {
      if (param_2 == 0x110) {
        ...
        SetWindowTextA(param_1,&DAT_0100adf4);
        DAT_0100a358 = CreateThread((LPSECURITY_ATTRIBUTES)0x0,0,FUN_0100463e,(LPVOID)0x0,0,
                                    (LPDWORD)&DAT_0100a668);
        if (DAT_0100a358 != (HANDLE)0xffffffff) {
          return 1;
        }
        FUN_01003c23(param_1,0x4b8,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
        param_3 = 0;
LAB_01003079:
        EndDialog(param_1,param_3);
        return 1;
      ...
      iVar1 = FUN_01003c23(DAT_0100aa78,0x4b2,"",(LPCSTR)0x0,0x20,4);
      if ((iVar1 != 6) && (iVar1 != 1)) {
        SetEvent(DAT_0100aa7c);
        return 1;
      }
      _DAT_0100ae78 = 1;
      SetEvent(DAT_0100aa7c);
      FUN_010030ac((char)DAT_0100a358);
      goto LAB_01003098;
    }
    if (param_3 != 0x1b) {
      return 1;
...
void FUN_010030ac(undefined param_1)
...

{
  ...
  if (BVar3 == 0) {
    ...
    if ((_DAT_0100aab4 == 0) && (param_1 != 0)) {
      ...
      local_c = 0;
      do {
        uVar4 = FUN_0100260a(local_b0.dwMajorVersion,local_b0.dwMinorVersion,
...
LAB_01003372:
      ...
      if (((local_8 == 0) && (*(int *)(param_1 + 0x7c) != 0)) &&
         (iVar6 = FUN_01002461(param_1,local_1b4,(HKEY)0x104,&local_c), iVar7 = local_c, iVar6 == 0)
         ) {
        local_8 = 0x54d;
      }
    }
...
LAB_0100314b:
  if ((local_8 == 0x54d) || (local_8 == 0x54c)) {
    ...
    if (local_8 == 0) goto LAB_0100320c;
    UVar12 = 0x10;
    pCVar10 = (LPCSTR)0x0;
    pBVar11 = (BYTE *)0x0;
  }
  FUN_01003c23((HWND)0x0,local_8,pCVar10,(LPCSTR)pBVar11,UVar12,0);
LAB_0100320c:
  return local_8 == 0;
}
...
undefined4 FUN_010033bc(void)

{
  DWORD DVar1;
  int iVar2;
  
  DVar1 = FUN_01003d7d("LICENSE",(undefined4 *)0x0,0);
  ...
  if (DAT_0100bc00 == (undefined4 *)0x0) {
    ...
    DVar1 = FUN_01003d7d("LICENSE",DAT_0100bc00,DVar1);
    if (DVar1 != 0) {
      ...
      if (iVar2 == 0) {
        ...
        iVar2 = FUN_010058e6(DAT_0100b6dc,(LPCSTR)0x7d1,(HWND)0x0,FUN_01002b83,0,0);
        LocalFree(DAT_0100bc00);
        if (iVar2 == 0) {
          DAT_0100b704 = 0x800704c7;
          return 0;
...

{
  ...
  if ((((byte)DAT_0100aab8 & 1) == 0) && ((DAT_0100b6d4 & 1) == 0)) {
    WVar2 = FUN_010058e6(DAT_0100b6dc,(LPCSTR)(0x7d5 - (uint)(DAT_0100a2f8 != 0)),(HWND)0x0,
                         FUN_01002f20,0,0);
  }
  else {
    WVar2 = FUN_0100463e();
  ...
  if (WVar2 == 0) {
    ...
    iVar3 = FUN_010056d8(FUN_010057eb);
    if (iVar3 != 0) {
      DAT_0100b704 = 0;
      return 1;
    }
...

{
  ...
  DAT_0100b704 = 0;
  if ((_DAT_0100aaa8 == 0) &&
     ((DVar1 = FUN_01003d7d("REBOOT",(undefined4 *)&DAT_0100b6cc,4), DVar1 == 0 || (4 < DVar1)))) {
LAB_0100380d:
    FUN_01003c23((HWND)0x0,0x4b1,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
    DAT_0100b704 = 0x80070714;
LAB_010038d5:
    ...
    do {
      ...
      local_84.cb = 0x44;
      if (DAT_0100acc2 == '\0') {
        DVar1 = FUN_01003d7d("SHOWWINDOW",&local_14,4);
        if ((DVar1 == 0) || (4 < DVar1)) goto LAB_0100380d;
        if (local_14 == 1) {
          local_84.dwFlags = 1;
        ...
        if (local_10 == 0) {
          if (DAT_0100aab8 != 0) {
            ...
            DVar1 = FUN_01003d7d(local_1c,local_188,0x104);
            if (DVar1 == 0) goto LAB_0100380d;
            iVar4 = lstrcmpiA((LPCSTR)local_188,"<None>");
            if (iVar4 != 0) {
              local_18 = 1;
            }
          }
          if ((local_18 == 0) && (DVar1 = FUN_01003d7d("RUNPROGRAM",local_188,0x104), DVar1 == 0))
          goto LAB_0100380d;
        }
      }
      else {
...
LAB_01003707:
        if (_DAT_0100a2fc == 0) {
          FUN_01003c23((HWND)0x0,0x4c7,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
LAB_01003886:
          LocalFree(local_8);
          DAT_0100b704 = 0x8007042b;
        }
        else {
          if ((local_c == 0) || ((DAT_0100b6d4 & 4) == 0)) goto LAB_010037d0;
          hModule = (HMODULE)FUN_01005886("advpack.dll");
          if (hModule == (HMODULE)0x0) {
            FUN_01003c23((HWND)0x0,0x4c8,"advpack.dll",(LPCSTR)0x0,0x10,0);
          }
          else {
            ...
            FUN_01003c23((HWND)0x0,0x4c9,s_DoInfInstall_0100a2e8,(LPCSTR)0x0,0x10,0);
            FreeLibrary(hModule);
          }
          LocalFree(local_8);
          DAT_0100b704 = FUN_010056b9();
...
LAB_010036fe:
      if (local_c != 0) goto LAB_01003707;
LAB_010037d0:
      iVar4 = FUN_010038dc(local_8,&local_84);
      if (iVar4 == 0) {
        DVar1 = GetLastError();
        FormatMessageA(0x1000,(LPCVOID)0x0,DVar1,0,local_388,0x200,(va_list *)0x0);
        FUN_01003c23((HWND)0x0,0x4c4,local_8,local_388,0x10,0);
        LocalFree(local_8);
        goto LAB_010038d5;
      }
LAB_010037e4:
...
undefined4 FUN_010038dc(LPSTR param_1,LPSTARTUPINFOA param_2)

{
  ...
  if (param_1 != (LPSTR)0x0) {
    ...
    if (BVar1 != 0) {
      ...
      GetExitCodeProcess(local_14.hProcess,(LPDWORD)&param_1);
      if ((((_DAT_0100aaa8 == 0) && (((uint)_DAT_0100b6cc & 1) != 0)) &&
          (((uint)_DAT_0100b6cc & 2) == 0)) && (((uint)param_1 & 0xff000000) == 0xaa000000)) {
        _DAT_0100b6cc = param_1;
      }
      FUN_0100567a((uint)param_1);
...

{
  ...
  DVar1 = FUN_01003d7d("FINISHMSG",(undefined4 *)0x0,0);
  lpString1 = (undefined4 *)LocalAlloc(0x40,DVar1 + 1);
  if (lpString1 == (undefined4 *)0x0) {
    FUN_01003c23((HWND)0x0,0x4b5,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
    return;
  }
  DVar1 = FUN_01003d7d("FINISHMSG",lpString1,DVar1);
  if (DVar1 == 0) {
    UVar5 = 0x10;
    UVar3 = 0x4b1;
    ...
    if (iVar2 == 0) goto LAB_010039f6;
    UVar5 = 0x40;
    UVar3 = 0x3e9;
    puVar4 = lpString1;
  }
  FUN_01003c23((HWND)0x0,UVar3,(LPCSTR)puVar4,(LPCSTR)0x0,UVar5,0);
LAB_010039f6:
  LocalFree(lpString1);
  return;
}
...
bool FUN_01003a23(HWND param_1,undefined4 param_2,LPSTR param_3)

{
  ...
  FUN_01003c23(param_1,UVar3,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
  return false;
}



void FUN_01003b58(HWND param_1,HWND param_2)
...
int FUN_01003c23(HWND param_1,UINT param_2,LPCSTR param_3,LPCSTR param_4,UINT param_5,uint param_6)

{
  ...
  *(undefined *)puVar5 = *(undefined *)puVar4;
  ...
  FUN_01003def(param_2,local_23c,0x200);
  if (local_23c[0] == '\0') {
...
DWORD FUN_01003d7d(LPCSTR param_1,undefined4 *param_2,uint param_3)
...
LPSTR FUN_01003def(UINT param_1,LPSTR param_2,int param_3)
...
undefined4 FUN_01003e16(LPSTR param_1,int param_2,LPCSTR param_3,LPCSTR param_4)
...
int FUN_01003e7d(LPCSTR param_1)

{
  ...
  iVar3 = 1;
  uVar1 = FUN_01005a6f(param_1);
  if (uVar1 != 0) {
    if ((_DAT_0100ae7c == 0) && (((byte)DAT_0100aab8 & 1) == 0)) {
      DAT_0100b0a4 = param_1;
      iVar2 = FUN_010058e6(DAT_0100b6dc,(LPCSTR)0x7d3,DAT_0100aa78,FUN_01002e91,0,6);
      if (iVar2 != 6) {
        if (iVar2 == 7) {
          iVar3 = 0;
        }
...
undefined4 FUN_01003f00(LPCSTR param_1)

{
  ...
  if (hMem == (LPSTR *)0x0) {
    FUN_01003c23(DAT_0100aa78,0x4b5,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
  }
  else {
    iVar1 = lstrlenA(param_1);
...
HANDLE FUN_01003f86(LPCSTR param_1,uint param_2)
...
void FUN_01004022(LPCSTR param_1)
...
int __cdecl FUN_0100408c(LPCSTR param_1,uint param_2)

{
  ...
  if (iVar5 == 0x28) {
    FUN_01003c23(DAT_0100aa78,0x4bb,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
  }
  else {
    ...
    if (iVar3 == 0) {
      ...
      pvVar4 = FUN_01003f86(param_1,param_2);
...
uint __cdecl FUN_01004151(int param_1,undefined4 *param_2,uint param_3)
...
DWORD __cdecl FUN_010041d7(int param_1,LPCVOID param_2,DWORD param_3)

{
  BOOL BVar1;
  DWORD DVar2;
  
  FUN_010030ac((char)DAT_0100aa7c);
  if (_DAT_0100ae78 == 0) {
...
undefined4 __cdecl FUN_01004266(int param_1)
...
DWORD __cdecl FUN_010042b9(int param_1,DWORD param_2,int param_3)
...
bool FUN_0100433a(int param_1,WORD param_2,WORD param_3)
...
ushort FUN_010043a0(ushort param_1)
...
int __cdecl FUN_010043d2(int param_1,int param_2)

{
  ...
  if (_DAT_0100ae78 == 0) {
    ...
    if (param_1 == 2) {
      ...
      iVar3 = FUN_01003e16(local_108,0x104,&DAT_0100ae84,*(LPCSTR *)(param_2 + 4));
      if (iVar3 != 0) {
        iVar3 = FUN_01003e7d(local_108);
        if (iVar3 == 0) {
          return 0;
        }
        iVar3 = FUN_0100408c(local_108,0x8302);
        if ((iVar3 != -1) && (iVar5 = FUN_01003f00(local_108), iVar5 != 0)) {
      ...
      iVar3 = FUN_01003e16(local_108,0x104,&DAT_0100ae84,*(LPCSTR *)(param_2 + 4));
      if ((iVar3 != 0) &&
         (bVar1 = FUN_0100433a(*(int *)(param_2 + 0x14),*(WORD *)(param_2 + 0x18),
                               *(WORD *)(param_2 + 0x1a)), CONCAT31(extraout_var,bVar1) != 0)) {
        FUN_01004266(*(int *)(param_2 + 0x14));
        uVar2 = FUN_010043a0(*(ushort *)(param_2 + 0x1c));
...
undefined4 FUN_01004537(int param_1)
...

{
  ...
  puVar1 = FUN_01005a90(&LAB_010043b6,&LAB_010043c3,FUN_0100408c,FUN_01004151,FUN_010041d7,
                        FUN_01004266,FUN_010042b9,1,local_10);
  if ((((puVar1 != (undefined4 *)0x0) &&
       (iVar3 = FUN_0100408c(s__MEMCAB_0100a230,0x8000), iVar3 != -1)) &&
      (iVar2 = FUN_01005ba0(puVar1,iVar3,local_28), iVar2 != 0)) &&
     (((local_28[0] == DAT_0100ade4 && (local_18 == 0)) &&
      ((local_14 == 0 && (iVar3 = FUN_01004266(iVar3), iVar3 != -1)))))) {
    iVar3 = FUN_01005b30(puVar1);
    return iVar3 != 0;
  }
  return false;
}
...

{
  ...
  if (CONCAT31(extraout_var_00,bVar1) == 0) {
    ...
    ppiVar3 = (int **)FUN_01005a90(&LAB_010043b6,&LAB_010043c3,FUN_0100408c,FUN_01004151,
                                   FUN_010041d7,FUN_01004266,FUN_010042b9,1,&DAT_0100ade8);
    if (ppiVar3 != (int **)0x0) {
      wParam = FUN_01005c70(ppiVar3,s__MEMCAB_0100a230,"",0,(int *)FUN_010043d2,(int *)0x0,
                            (int *)&DAT_0100ade0);
      if (wParam == 0) goto LAB_01004720;
      iVar5 = FUN_01005b30(ppiVar3);
      if (iVar5 != 0) goto LAB_01004720;
    }
    UVar4 = DAT_0100ade8 + 0x514;
  }
  FUN_01003c23(DAT_0100aa78,UVar4,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
  wParam = 0;
LAB_01004720:
  ...
  if ((wParam == 0) && (_DAT_0100ae78 == 0)) {
    FUN_01003c23((HWND)0x0,0x4f8,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
  }
  if ((((byte)DAT_0100aab8 & 1) == 0) && ((DAT_0100b6d4 & 1) == 0)) {
...
bool FUN_0100477d(void)

{
  HRSRC hResInfo;
  HGLOBAL hResData;
  
  DAT_0100ade4 = FUN_01003d7d("CABINET",(undefined4 *)0x0,0);
...

{
  ...
  DVar1 = FUN_01003d7d("FILESIZES",&DAT_0100b6e0,0x24);
  if (DVar1 == 0x24) {
    DAT_0100b098 = DAT_0100b700;
    if (DAT_0100b700 != 0) {
      FUN_01003d7d("PACKINSTSPACE",&DAT_0100b6d8,4);
      iVar2 = FUN_010056d8(&LAB_010057ab);
      if (iVar2 == 0) {
        FUN_01003c23((HWND)0x0,0x4c6,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
        return 0;
      }
      return 1;
    }
  ...
  FUN_01003c23((HWND)0x0,UVar3,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
  DAT_0100b704 = 0x80070714;
  return 0;
}
...

{
  ...
  DVar1 = FUN_01003d7d("UPROMPT",(undefined4 *)0x0,0);
  lpString1 = (undefined4 *)LocalAlloc(0x40,DVar1 + 1);
  if (lpString1 == (undefined4 *)0x0) {
    FUN_01003c23((HWND)0x0,0x4b5,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
    DAT_0100b704 = FUN_010056b9();
    ...
    DVar1 = FUN_01003d7d("UPROMPT",lpString1,DVar1);
    if (DVar1 != 0) {
      iVar2 = lstrcmpA((LPCSTR)lpString1,"<None>");
      if (iVar2 == 0) {
        LocalFree(lpString1);
        ...
        iVar2 = FUN_01003c23((HWND)0x0,0x3e9,(LPCSTR)lpString1,(LPCSTR)0x0,0x20,4);
        LocalFree(lpString1);
        if (iVar2 != 6) {
          DAT_0100b704 = 0x800704c7;
          return 0;
...

{
  ...
  if (((DAT_0100aaa0 != 0) && (_DAT_0100aaa4 == 0)) && (_DAT_0100b6d0 == 0)) {
    ...
    if ((DAT_0100b6d4 & 0x20) != 0) {
      FUN_01005a29(local_104);
    }
    SetCurrentDirectoryA("..");
    FUN_01001f66(local_104);
  }
  if ((DAT_0100bc04 != 1) && (DAT_0100aaa0 != 0)) {
    FUN_01001c31();
  }
...
int FUN_010049d7(LPCSTR param_1,LPSTR param_2)

{
  ...
  do {
    ...
    FUN_010059ea(param_2,local_104);
...
undefined4 FUN_01004a8c(LPCSTR param_1,int param_2,uint param_3)

{
  ...
  iVar2 = FUN_010049d7(param_1,local_12c);
  if (iVar2 == 0) {
    return 0;
  }
  ...
  if ((DAT_0100b6d4 & 0x20) != 0) {
    ...
    if (local_28.u.s.wProcessorArchitecture == 0) {
      ...
      if (local_28.u.s.wProcessorArchitecture != 3) goto LAB_01004b0c;
      pcVar4 = "ppc";
    }
    FUN_010059ea(&DAT_0100ae84,pcVar4);
  }
LAB_01004b0c:
  FUN_010059ea(&DAT_0100ae84,"");
LAB_01004b28:
  ...
  bVar1 = FUN_01004f10(&DAT_0100ae84,param_3,0);
  if (CONCAT31(extraout_var,bVar1) == 0) {
    if (DAT_0100aaa0 != 0) {
      DAT_0100aaa0 = 0;
...

{
  ...
  DVar2 = FUN_01003d7d("RUNPROGRAM",(undefined4 *)0x0,0);
  ...
  if (lpString1 == (undefined4 *)0x0) {
    ...
    DVar2 = FUN_01003d7d("RUNPROGRAM",lpString1,DVar2);
    if (DVar2 == 0) {
      FUN_01003c23((HWND)0x0,0x4b1,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
      LocalFree(lpString1);
      DAT_0100b704 = 0x80070714;
      ...
      if (DAT_0100abbe == '\0') {
        if ((_DAT_0100aaa4 != 0) || (_DAT_0100b6d0 != 0)) {
          iVar3 = FUN_010058e6(DAT_0100b6dc,(LPCSTR)0x7d2,(HWND)0x0,FUN_01002c72,0,0);
          return iVar3;
        }
        DVar2 = GetTempPathA(0x104,&DAT_0100ae84);
        if (DVar2 != 0) {
          iVar3 = FUN_01004a8c(&DAT_0100ae84,1,3);
          if (iVar3 != 0) {
            return 1;
          }
          bVar1 = FUN_01002245(&DAT_0100ae84);
          if ((CONCAT31(extraout_var,bVar1) == 0) &&
             (iVar3 = FUN_01004a8c(&DAT_0100ae84,1,1), iVar3 != 0)) {
            return 1;
          }
        }
        do {
          lstrcpyA(local_118,"A:\\");
          while (local_118[0] < '[') {
            UVar4 = GetDriveTypeA(local_118);
            if (((((UVar4 == 6) || (UVar4 == 3)) &&
                 (DVar2 = GetFileAttributesA(local_118), DVar2 != 0xffffffff)) ||
                (((UVar4 == 2 && (local_118[0] != 'A')) &&
                 ((local_118[0] != 'B' &&
                  ((BVar5 = GetDiskFreeSpaceA(local_118,&local_8,&local_10,&local_14,&local_c),
                   BVar5 != 0 && (99999999 < local_c * local_10 * local_8)))))))) &&
               ((bVar1 = FUN_01004f10(local_118,3,0), CONCAT31(extraout_var_00,bVar1) != 0 ||
                ((bVar1 = FUN_01002245(local_118), CONCAT31(extraout_var_01,bVar1) == 0 &&
                 (bVar1 = FUN_01004f10(local_118,1,0), CONCAT31(extraout_var_02,bVar1) != 0)))))) {
              bVar1 = FUN_01002245(local_118);
              if (CONCAT31(extraout_var_03,bVar1) != 0) {
                GetWindowsDirectoryA(local_118,0x104);
              }
              FUN_010059ea(local_118,"msdownld.tmp");
              uVar6 = FUN_01002222(local_118);
              if (uVar6 == 0) {
                local_118[0] = local_118[0] + '\x01';
                local_115 = 0;
              }
              else {
                SetFileAttributesA(local_118,2);
                lstrcpyA(&DAT_0100ae84,local_118);
                iVar3 = FUN_01004a8c(&DAT_0100ae84,1,0);
                if (iVar3 != 0) {
                  return 1;
                }
              }
          ...
          GetWindowsDirectoryA(local_118,0x104);
          bVar1 = FUN_01004f10(local_118,3,4);
        ...
        iVar3 = FUN_01004a8c(&DAT_0100abbe,0,uVar6);
        if (iVar3 != 0) {
          return 1;
        }
        FUN_01003c23((HWND)0x0,0x4be,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
      }
    }
  }
  return 0;
...
undefined4 FUN_01004e71(LPCSTR param_1)

{
  ...
  if (lpString1 == (LPSTR)0x0) {
    ...
    lstrcpyA(lpString1,param_1);
    FUN_010059ea(lpString1,"~TMP4352.TMP");
...
bool FUN_01004f10(LPCSTR param_1,uint param_2,int param_3)

{
  ...
  GetCurrentDirectoryA(0x104,local_128);
  ...
  if (BVar1 == 0) {
    ...
    BVar1 = GetDiskFreeSpaceA((LPCSTR)0x0,&local_8,&local_10,&local_c,&local_20);
    if (BVar1 == 0) {
      local_328 = '\0';
      puVar8 = &local_327;
      ...
      *(undefined *)((int)puVar8 + 2) = 0;
      ...
      DVar12 = 0;
      DVar2 = GetLastError();
      FormatMessageA(0x1000,(LPCVOID)0x0,DVar2,DVar12,pCVar13,DVar14,ppcVar15);
      UVar11 = 0x4b0;
    }
    else {
      ...
      if (BVar1 != 0) {
        ...
        iVar5 = 0x200;
        uVar7 = local_10 * local_8 * local_c;
        uVar4 = 0;
        do {
          if (local_10 * local_8 - iVar5 == 0) break;
          iVar5 = iVar5 << 1;
          uVar4 = uVar4 + 1;
        } while (uVar4 < 8);
        if (uVar4 == 8) {
          FUN_01003c23((HWND)0x0,0x4c5,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
          return false;
        }
        if (((DAT_0100b6d4 & 8) == 0) || ((local_1c._1_1_ & 0x80) == 0)) {
          uVar3 = (&DAT_0100b6e0)[uVar4];
          uVar6 = DAT_0100b6d8;
        }
        else {
          uVar3 = (&DAT_0100b6e0)[uVar4] << 1;
          uVar6 = (DAT_0100b6d8 >> 2) + DAT_0100b6d8;
        }
        if (((param_2 & 1) == 0) || ((param_2 & 2) == 0)) {
          ...
          bVar9 = uVar6 + uVar3 < uVar7;
          bVar10 = uVar6 + uVar3 == uVar7;
        }
        if (bVar9 || bVar10) {
          DAT_0100b704 = 0;
          return true;
        }
        bVar9 = FUN_010022a5(param_3,uVar3,uVar6,local_18);
        return bVar9;
      }
      local_328 = '\0';
      puVar8 = &local_327;
    ...
    FUN_01003c23((HWND)0x0,UVar11,param_1,&local_328,0x10,0);
    SetCurrentDirectoryA(local_128);
  }
  return false;
}
...
undefined4 FUN_01005129(char *param_1,int *param_2)
...

{
  ...
  pcVar4 = param_1;
  do {
    if ((cVar3 == '\0') || (local_8 == 0)) goto LAB_010055e2;
    for (; (cVar3 = *pcVar4, cVar3 == ' ' ||
           ((((cVar3 == '\t' || (cVar3 == '\r')) || (cVar3 == '\n')) ||
            ((cVar3 == '\v' || (cVar3 == '\f')))))); pcVar4 = CharNextA(pcVar4)) {
    }
    if (*pcVar4 == '\0') goto LAB_010055e2;
    iVar9 = 0;
    bVar1 = false;
    bVar2 = false;
    local_c = pcVar4;
...
LAB_010055e2:
        ...
        if (DAT_0100abbe == '\0') {
          DVar7 = GetModuleFileNameA(DAT_0100b6dc,&DAT_0100abbe,0x104);
          if (DVar7 == 0) {
            return 0;
          }
          psVar8 = FUN_010059b8((short *)&DAT_0100abbe,0x5c);
          *(undefined *)((int)psVar8 + 1) = 0;
          return local_8;
        }
        return local_8;
      }
    ...
    pCVar5 = CharUpperA((LPSTR)(int)local_110[1]);
    cVar3 = (char)pCVar5;
    if (cVar3 == '?') {
      FUN_01001b01();
      if (DAT_0100aa80 != (HANDLE)0x0) {
    ...
    if (cVar3 == 'C') {
      if (local_110[2] == '\0') {
        ...
        if (local_110[2] == ':') {
          pcVar4 = (char *)(((char)local_10d == '\"') + 3);
          psVar8 = (short *)(local_110 + (int)pcVar4);
          iVar9 = lstrlenA((LPCSTR)psVar8);
          if ((((iVar9 != 0) &&
               ((psVar6 = FUN_01005988(psVar8,0x5b), psVar6 == (short *)0x0 ||
                (psVar6 = FUN_01005988(psVar8,0x5d), psVar6 != (short *)0x0)))) &&
              ((psVar6 = FUN_01005988(psVar8,0x5d), psVar6 == (short *)0x0 ||
               (psVar6 = FUN_01005988(psVar8,0x5b), psVar6 != (short *)0x0)))) &&
             (param_1 = pcVar4, iVar9 = FUN_01005129((char *)psVar8,(int *)&param_1), iVar9 != 0)) {
            lstrcpyA(&DAT_0100acc2,local_110 + (int)(param_1 + (int)pcVar4));
            goto LAB_010055ce;
          }
        }
LAB_010055cb:
...
LAB_01005468:
        if (local_110[2] == ':') {
          pcVar4 = (char *)(((char)local_10d == '\"') + 3);
          iVar9 = lstrlenA(local_110 + (int)pcVar4);
          if ((iVar9 != 0) &&
             (param_1 = pcVar4, iVar9 = FUN_01005129(local_110 + (int)pcVar4,(int *)&param_1),
             iVar9 != 0)) {
            pCVar5 = CharUpperA((LPSTR)(int)local_110[1]);
            if ((char)pCVar5 == 'T') {
              lpString1 = &DAT_0100abbe;
              pcVar4 = local_110 + (int)(param_1 + (int)pcVar4);
            }
            else {
              lpString1 = &DAT_0100aaba;
              pcVar4 = local_110 + (int)(param_1 + (int)pcVar4);
            }
            lstrcpyA(lpString1,pcVar4);
            FUN_010059ea(lpString1,"");
            iVar9 = FUN_01002c42(lpString1);
            if (iVar9 == 0) {
              return 0;
            }
            goto LAB_010055ce;
      ...
      if (cVar3 == 'N') {
        if (local_110[2] == '\0') {
          ...
          if (local_110[2] != ':') goto LAB_010055cb;
          if ((char)local_10d != '\0') {
            pcVar4 = local_110 + 3;
            do {
              cVar3 = *pcVar4;
              pcVar4 = pcVar4 + 1;
              pCVar5 = CharUpperA((LPSTR)(int)cVar3);
              cVar3 = (char)pCVar5;
              if (cVar3 == 'E') {
                _DAT_0100aaac = 1;
              }
        ...
        if (local_110[2] != '\0') {
          if (local_110[2] != ':') goto LAB_010055cb;
          pCVar5 = CharUpperA((LPSTR)(int)(char)local_10d);
          cVar3 = (char)pCVar5;
          if (cVar3 != '1') {
            if (cVar3 == 'A') {
              DAT_0100aab8 = 1;
        ...
        if (local_110[2] == '\0') {
          ...
          if (local_110[2] != ':') {
            iVar9 = lstrcmpiA("RegServer",local_110 + 1);
            if (iVar9 == 0) goto LAB_010055ce;
            goto LAB_010055cb;
          }
          _DAT_0100b6cc = 1;
          if ((char)local_10d != '\0') {
...

{
  ...
  bVar1 = FUN_01004f10(local_108,2,2);
  return bVar1;
}



void FUN_0100567a(uint param_1)
...
undefined4 FUN_010056d8(undefined *param_1)
...
undefined4 FUN_010057eb(DWORD param_1,undefined4 param_2,LPCSTR param_3,LPCVOID param_4)

{
  ...
  local_c = 0;
  lstrcpyA(local_110,&DAT_0100ae84);
  FUN_010059ea(local_110,param_3);
  ...
  if (hFile != (HANDLE)0xffffffff) {
    ...
    if ((BVar1 != 0) && (param_1 == local_c)) goto LAB_01005870;
  }
...
void FUN_01005886(LPCSTR param_1)

{
  ...
  FUN_010059ea(local_108,param_1);
...
int FUN_010058e6(HMODULE param_1,LPCSTR param_2,HWND param_3,DLGPROC param_4,int param_5,int param_6
                )

{
  ...
  if (iVar1 == -1) {
    FUN_01003c23((HWND)0x0,0x4fb,(LPCSTR)0x0,(LPCSTR)0x0,0x10,0);
    iVar1 = param_6;
  }
  return iVar1;
}
...
bool FUN_0100595b(short param_1,short param_2)
...
short * FUN_01005988(short *param_1,short param_2)

{
  ...
  while( true ) {
    ...
    bVar1 = FUN_0100595b(*param_1,param_2);
...
short * FUN_010059b8(short *param_1,short param_2)
...
void FUN_010059ea(LPCSTR param_1,LPCSTR param_2)
...
undefined4 FUN_01005a29(LPCSTR param_1)
...
uint FUN_01005a6f(LPCSTR param_1)
...
undefined4 * __cdecl
FUN_01005a90(undefined *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...
undefined4 __cdecl FUN_01005b30(undefined4 *param_1)

{
  FUN_01006d00(0xf,param_1);
  if (param_1[0x13] != 0) {
...
undefined4 __cdecl FUN_01005ba0(undefined4 *param_1,undefined4 param_2,undefined4 *param_3)

{
  ...
  if ((short)uStack_c != 0x103) {
    FUN_01007370((undefined4 *)*param_1,3,uStack_c & 0xffff);
    return 0;
  }
...
undefined4 __cdecl
FUN_01005c70(int **param_1,char *param_2,char *param_3,undefined4 param_4,int *param_5,int *param_6,
            int *param_7)

{
  ...
  *(undefined2 *)((int)param_1 + 0xae) = 0;
  ...
  bVar4 = FUN_01005f20(param_1,param_2,0,-1);
    ...
    while (iVar5 != 0) {
      do {
        ...
        *(short *)(param_1 + 0x2b) = sVar3 + -1;
        ...
        iVar5 = FUN_010069b0(param_1);
        if (iVar5 == 0) goto LAB_01005ece;
...
bool __cdecl FUN_01005f20(undefined4 *param_1,char *param_2,short param_3,short param_4)

{
  ...
  if (iVar6 != -1) {
    ...
    if (iVar6 != -1) {
      ...
      if (iVar6 != 0x24) {
        FUN_01007370((undefined4 *)*param_1,2,0);
        return false;
      }
      ...
      if ((param_4 != -1) && ((sStack_4 != param_3 || (sStack_2 != param_4)))) {
        FUN_01007370((undefined4 *)*param_1,10,0);
        return false;
      }
      piVar8 = aiStack_24;
      ...
      if ((*(byte *)((int)param_1 + 0x6e) & 4) != 0) {
        ...
        if (param_1[0x28] == 0xffff) {
          ...
          if (uVar4 != 0) {
            ...
            param_1[0x13] = iVar6;
            if (iVar6 == 0) {
              FUN_01007370((undefined4 *)*param_1,5,0);
              return false;
            }
          }
        }
      ...
      if (param_1[0x11] == 0) {
        ...
        FUN_01007370((undefined4 *)*param_1,9,0);
        return false;
      }
      ...
      if ((*(byte *)((int)param_1 + 0x6e) & 1) == 0) {
        ...
        *(undefined *)((int)param_1 + 0x2b6) = 0;
        ...
        iVar6 = FUN_01006b70((char *)((int)param_1 + 0x1b5),0x100,param_1);
        if (iVar6 == 0) {
          return false;
        }
        iVar6 = FUN_01006b70((char *)((int)param_1 + 0x2b6),0x100,param_1);
        if (iVar6 == 0) {
          return false;
        }
      }
      if ((*(byte *)((int)param_1 + 0x6e) & 2) == 0) {
        ...
        *(undefined *)(param_1 + 0x12e) = 0;
        ...
        iVar6 = FUN_01006b70((char *)((int)param_1 + 0x3b7),0x100,param_1);
        if ((iVar6 == 0) ||
           (iVar6 = FUN_01006b70((char *)(param_1 + 0x12e),0x100,param_1), iVar6 == 0)) {
          return false;
        }
      }
  ...
  FUN_01007370((undefined4 *)*param_1,1,0);
  return false;
}



undefined4 __cdecl FUN_01006360(int **param_1)
...
LAB_0100647a:
    ...
    iVar2 = FUN_01006810(param_1,(int *)(uint)*(ushort *)(param_1 + 0x1f));
    while (iVar2 != 0) {
      if (piVar6 < (int *)((uint)*(ushort *)((int)param_1[0x12] + 6) + (int)param_1[0xc]))
      goto LAB_010063bf;
      iVar2 = FUN_010064e0(param_1);
    }
  }
  goto LAB_01006485;
  while( true ) {
    ...
    if ((piVar4 != (int *)0x0) && (iVar2 = FUN_010064e0(param_1), iVar2 == 0)) break;
LAB_010063bf:
    if (piVar4 == (int *)0x0) goto LAB_0100640c;
  }
LAB_01006485:
...
undefined4 __cdecl FUN_010064e0(int **param_1)

{
  ...
  if (*(short *)(param_1 + 0x2c) == 0) {
    iVar1 = FUN_010065c0(param_1);
    if (iVar1 == 0) {
      return 0;
    }
  }
  *(short *)(param_1 + 0x2c) = *(short *)(param_1 + 0x2c) + -1;
  iVar1 = FUN_01006a00(param_1,0);
  if (iVar1 == 0) {
    return 0;
  }
  if (*(short *)((int)param_1[0x12] + 6) == 0) {
    iVar1 = FUN_010065c0(param_1);
    if (iVar1 != 0) {
      iVar1 = FUN_01006a00(param_1,(uint)*(ushort *)(param_1[0x12] + 1));
      if (iVar1 != 0) {
        *(short *)(param_1 + 0x2c) = *(short *)(param_1 + 0x2c) + -1;
        goto LAB_01006564;
      }
...
LAB_01006564:
  ...
  iVar1 = FUN_010071e0(param_1,&local_2);
  if (iVar1 == 0) {
    return 0;
  }
  if (*(ushort *)((int)param_1[0x12] + 6) != local_2) {
    FUN_01007370(*param_1,7,0);
    return 0;
  }
  return 1;
}
...
undefined4 __cdecl FUN_010065c0(int **param_1)
  ...
  *(short *)(param_1 + 0x1f7) = sVar5;
  ...
  do {
    ...
    if (param_1[0x21] != (int *)0xffffffff) {
      ...
      if (iVar4 != 0) goto LAB_010066f3;
    }
    if (param_1[0x22] != (int *)0xffffffff) {
      iVar4 = (*(code *)param_1[6])(param_1[0x22]);
      if (iVar4 != 0) {
LAB_010066f3:
        FUN_01007370(*param_1,4,0);
        return 0;
      }
    }
    param_1[0x22] = (int *)0xffffffff;
    ...
    bVar3 = FUN_01005f20(param_1,(char *)((int)param_1 + 0x3b7),sVar1,sVar5);
...
LAB_0100669a:
      ...
      iVar4 = FUN_01006890(param_1,0);
      if (iVar4 == 0) goto LAB_0100669a;
    }
...
undefined4 __cdecl FUN_01006750(undefined4 *param_1)

{
  ...
  *(undefined2 *)(param_1 + 0x1f7) = *(undefined2 *)((int)param_1 + 0x72);
  ...
  if (iVar1 == -1) {
    FUN_01007370((undefined4 *)*param_1,0xb,0);
    return 0;
  }
  if (param_1[10] != 0) {
    param_1[0x1f9] = 0;
...
undefined4 __cdecl FUN_01006810(int **param_1,int *param_2)

{
  ...
  iVar1 = FUN_01007110(param_1);
  if ((iVar1 != 0) && (iVar1 = FUN_01006890(param_1,(int)param_2), iVar1 != 0)) {
    iVar1 = FUN_010064e0(param_1);
    if (iVar1 != 0) {
      param_1[0xc] = (int *)0x0;
      return 1;
    }
...
undefined4 __cdecl FUN_01006890(undefined4 *param_1,int param_2)
    ...
    if (iVar4 == iVar3) {
      ...
      if (iVar3 != -1) {
        *(undefined2 *)(param_1 + 0x2c) = *(undefined2 *)(param_1[0x11] + 4);
        bVar1 = FUN_01006d00(*(short *)(param_1[0x11] + 6),param_1);
        if (CONCAT31(extraout_var,bVar1) == 0) {
          return 0;
        }
        if (param_1[10] != 0) {
...
undefined4 __cdecl FUN_010069b0(undefined4 *param_1)

{
  ...
  if (iVar1 == 0x10) {
    iVar1 = FUN_01006b70((char *)(param_1 + 0x2d),0x100,param_1);
    if (iVar1 != 0) {
      return 1;
    }
  }
...
undefined4 __cdecl FUN_01006a00(undefined4 *param_1,int param_2)
    ...
    if (uVar5 + param_2 < (uint)param_1[0x26] || uVar5 + param_2 == param_1[0x26]) {
      ...
      if ((uint)uVar7 == uVar5) {
        if (*(int *)param_1[0x12] != 0) {
          ...
          uVar7 = FUN_0100738c(extraout_ECX,(int)((ulonglong)uVar7 >> 0x20),
                               (uint *)(param_1[0xf] + param_2),(uint)*(ushort *)puVar6,0);
          uVar7 = FUN_0100738c(extraout_ECX_00,(int)((ulonglong)uVar7 >> 0x20),puVar6,
...
undefined4 __cdecl FUN_01006b70(char *param_1,int param_2,undefined4 *param_3)

{
  ...
  if (iVar4 < 1) {
    FUN_01007370((undefined4 *)*param_3,4,0);
    return 0;
  }
  uVar5 = 0xffffffff;
...
undefined4 __cdecl FUN_01006c30(undefined4 *param_1)
...
bool __cdecl FUN_01006d00(short param_1,undefined4 *param_2)

{
  ...
  iVar1 = FUN_01006d60(param_2);
  if (iVar1 == 0) {
    FUN_01007370((undefined4 *)*param_2,7,0);
    return false;
  }
  *(short *)((int)param_2 + 0xb2) = param_1;
  iVar1 = FUN_01006e50(param_2);
  return (bool)('\x01' - (iVar1 == 0));
}



undefined4 __cdecl FUN_01006d60(undefined4 *param_1)

{
  ...
  case 1:
    iVar1 = FUN_0100595a();
    if (iVar1 != 0) {
      FUN_01007370((undefined4 *)*param_1,7,0);
      return 0;
    }
    break;
  case 2:
    ...
    break;
  case 3:
    iVar1 = FUN_010075c0((int *)param_1[0xd]);
    if (iVar1 != 0) {
      FUN_01007370((undefined4 *)*param_1,7,0);
      return 0;
    }
    break;
  default:
    FUN_01007370((undefined4 *)*param_1,6,0);
    return 0;
  case 0xf:
    return 1;
  }
...
undefined4 __cdecl FUN_01006e50(undefined4 *param_1)

{
  ...
  *piVar1 = 0x8000;
  ...
  case 2:
    iVar3 = FUN_01005957();
    goto joined_r0x01006f40;
  case 3:
    local_8[0] = 1 << ((byte)(*(ushort *)((int)param_1 + 0xb2) >> 8) & 0x1f);
    iVar3 = FUN_01007410(piVar1,local_8,(undefined *)0x0,(undefined *)0x0,param_1 + 0x26,
...
LAB_01006f42:
  ...
  if (iVar4 != 0) {
    FUN_01007370((undefined4 *)*param_1,iVar4,0);
  ...
  if (uVar2 == 1) {
    ...
    if (uVar2 != 3) goto LAB_01007091;
    iVar3 = FUN_01007410(piVar1,local_8,(undefined *)param_1[2],(undefined *)param_1[1],
...
undefined4 __cdecl FUN_01007110(undefined4 *param_1)

{
  ...
  case 2:
    ...
    break;
  case 3:
    iVar1 = FUN_01007590((int *)param_1[0xd]);
    if (iVar1 != 0) {
      FUN_01007370((undefined4 *)*param_1,7,0);
      return 0;
    }
...
undefined4 __cdecl FUN_010071e0(undefined4 *param_1,ushort *param_2)

{
  ...
  case 3:
    local_4 = (uint)*param_2;
    bVar2 = FUN_01007510((int *)param_1[0xd],param_1[0xf],(uint)*(ushort *)(param_1[0x12] + 4),
...
void __cdecl FUN_01007370(undefined4 *param_1,undefined4 param_2,undefined4 param_3)
...
FUN_0100738c(undefined4 param_1,undefined4 param_2,uint *param_3,uint param_4,uint param_5)
...
LAB_010073ec:
    ...
    if (uVar6 == 2) goto LAB_010073ec;
    if (uVar6 != 1) goto LAB_01007403;
  }
...
undefined4 __cdecl
FUN_01007410(int *param_1,uint *param_2,undefined *param_3,undefined *param_4,int *param_5,
...

{
  ...
  *param_6 = 0;
  ...
  puVar1[9] = param_2[1];
  *puVar1 = 0x4349444c;
  iVar2 = FUN_01007600((int *)puVar1[10],*param_2,(int)param_3,(int)param_4,param_7,param_8,param_9,
                       param_10,param_11);
  if (iVar2 == 0) {
    (*(code *)param_4)(puVar1);
    return 1;
...
byte __cdecl FUN_01007510(int *param_1,int param_2,int param_3,int param_4,uint *param_5)

{
  ...
  iVar2 = FUN_010076d0((int *)param_1[10],uVar1,param_2,param_3,param_4,uVar1,&local_4);
  *param_5 = local_4;
  return (iVar2 == 0) - 1U & 4;
}
...
undefined4 __cdecl FUN_01007590(int *param_1)

{
  if (*param_1 != 0x4349444c) {
    return 2;
  }
  FUN_010076a0(param_1[10]);
  return 0;
}



undefined4 __cdecl FUN_010075c0(int *param_1)

{
  if (*param_1 != 0x4349444c) {
    return 2;
  }
  FUN_01007690((int *)param_1[10]);
  *param_1 = 0;
...
undefined4 __cdecl
FUN_01007600(int *param_1,uint param_2,int param_3,int param_4,int param_5,int param_6,int param_7,
...

{
  ...
  bVar1 = FUN_01007740(param_1);
  if (CONCAT31(extraout_var,bVar1) == 0) {
    return 0;
  }
  FUN_010076a0((int)param_1);
  return 1;
}



void __cdecl FUN_01007690(int *param_1)

{
  FUN_010077a0(param_1);
  return;
}



void __cdecl FUN_010076a0(int param_1)

{
  FUN_010077c0(param_1);
  FUN_01007820(param_1);
  FUN_01007870(param_1);
...
undefined4 __cdecl
FUN_010076d0(int *param_1,int param_2,int param_3,int param_4,int param_5,undefined4 param_6,
            uint *param_7)

{
  ...
  FUN_01007bd0((int)param_1);
  uVar1 = FUN_010078b0(param_1,param_2);
...
bool __cdecl FUN_01007740(int *param_1)
...
void __cdecl FUN_010077c0(int param_1)
...
void __cdecl FUN_01007820(int param_1)
...
void __cdecl FUN_01007870(int param_1)
...
void __cdecl FUN_01007880(int param_1,undefined4 param_2,int param_3)

{
  undefined8 uVar1;
  
  uVar1 = FUN_01007cd4(param_2,*(undefined4 *)(param_1 + 0x2ec4),*(char **)(param_1 + 0x2ec8),
...
uint __cdecl FUN_010078b0(int *param_1,int param_2)

{
  ...
  if (0 < param_2) {
    do {
      if (param_1[2999] == 1) {
        if (param_1[0xbae] != 0) {
          param_1[0xbae] = 0;
          uVar1 = FUN_01007cb0((int)param_1,1);
          if (uVar1 == 0) {
            param_1[0xbb1] = 0;
          }
          else {
            uVar1 = FUN_01007cb0((int)param_1,0x10);
            uVar2 = FUN_01007cb0((int)param_1,0x10);
        ...
        if (param_1[0xbb6] == 3) {
          ...
          param_1[0xbb6] = 0;
          FUN_01007b80((int)param_1);
        }
        uVar1 = FUN_01007cb0((int)param_1,3);
        param_1[0xbb6] = uVar1;
        uVar1 = FUN_01007cb0((int)param_1,8);
        uVar2 = FUN_01007cb0((int)param_1,8);
        uVar3 = FUN_01007cb0((int)param_1,8);
        iVar4 = uVar3 + (uVar1 * 0x100 + uVar2) * 0x100;
        param_1[0xbb4] = iVar4;
        param_1[0xbb5] = iVar4;
        if (param_1[0xbb6] == 2) {
          FUN_01008140((int)param_1);
        }
        iVar4 = param_1[0xbb6];
        if ((iVar4 == 1) || (iVar4 == 2)) {
          ...
          *(undefined *)piVar7 = *(undefined *)piVar6;
          FUN_01007df0((int)param_1);
        }
        else {
          if (iVar4 != 3) {
            return 0xffffffff;
          }
          iVar4 = FUN_01008210((int)param_1);
          if (iVar4 == 0) {
            return 0xffffffff;
          }
        }
      ...
      if (0 < iVar4) {
        do {
          ...
          iVar5 = FUN_01007b10(param_1,param_1[0xbb6],param_1[0xbb0],iVar4);
          if (iVar5 != 0) {
            return 0xffffffff;
          }
          iVar5 = param_1[0xbb5];
  ...
  FUN_01007da0((int)param_1,local_4,(undefined4 *)((iVar4 - local_4) + *param_1));
  return local_4;
}



int __cdecl FUN_01007b10(int *param_1,int param_2,uint param_3,int param_4)

{
  int iVar1;
  
  if (param_2 == 2) {
    iVar1 = FUN_010088f0(param_1,param_3,param_4);
    return iVar1;
  }
  if (param_2 == 1) {
    iVar1 = FUN_01008280(param_3,param_1,param_1,param_3,param_4);
    return iVar1;
  }
  if (param_2 == 3) {
    iVar1 = FUN_01008190(param_1,param_3,param_4);
    return iVar1;
  }
  return -1;
}
...
void __cdecl FUN_01007b80(int param_1)
...
void __cdecl FUN_01007bd0(int param_1)

{
  FUN_01007b80(param_1);
  return;
}



void __cdecl FUN_01007be0(int param_1,byte param_2)
...
uint __cdecl FUN_01007cb0(int param_1,byte param_2)

{
  uint uVar1;
  
  uVar1 = *(uint *)(param_1 + 0x2eb0);
  FUN_01007be0(param_1,param_2);
...
undefined8 __fastcall
FUN_01007cd4(undefined4 param_1,undefined4 param_2,char *param_3,uint param_4,char *param_5,
            int param_6)
...
void __cdecl FUN_01007da0(int param_1,uint param_2,undefined4 *param_3)

{
  ...
  if ((*(int *)(param_1 + 0x2ec4) != 0) && (*(uint *)(param_1 + 0x2ecc) < 0x8000)) {
    FUN_01007880(param_1,*(undefined4 *)(param_1 + 0x2b0c),param_2);
  }
  return;
}
...
bool __cdecl FUN_01007df0(int param_1)

{
  ...
  bVar2 = FUN_01007ed0(param_1,0x100,param_1 + 0x2b14,param_1 + 0xa18);
  if (CONCAT31(extraout_var,bVar2) == 0) {
    return false;
  }
  bVar2 = FUN_01007ed0(param_1,(uint)*(byte *)(param_1 + 0x2eb5) << 3,param_1 + 0x2c14,
                       param_1 + 0xb18);
  if (CONCAT31(extraout_var_00,bVar2) == 0) {
    return false;
  }
  iVar1 = (uint)*(byte *)(param_1 + 0x2eb5) * 8 + 0x100;
  uVar3 = FUN_01008cac(iVar1,extraout_EDX,param_1,iVar1,param_1 + 0xa18,10,
                       (undefined4 *)(param_1 + 0x18),param_1 + 0xe3c);
  if ((int)uVar3 == 0) {
    return false;
  }
  bVar2 = FUN_01007ed0(param_1,0xf9,param_1 + 0x2db4,param_1 + 0xcb8);
  if (CONCAT31(extraout_var_01,bVar2) == 0) {
    return false;
  }
  uVar3 = FUN_01008cac(param_1 + 0x818,extraout_EDX_00,param_1,0xf9,param_1 + 0xcb8,8,
...
bool __cdecl FUN_01007ed0(int param_1,int param_2,int param_3,int param_4)

{
  ...
  iVar5 = 0;
  FUN_01008cac(local_200,local_2d4,param_1,0x14,(int)local_2d4,8,(undefined4 *)local_200,
               (int)local_2bc);
  if (0 < param_2) {
    do {
      ...
      FUN_01007be0(param_1,local_2d4[sVar3]);
      if (*(int *)(param_1 + 0x2ebc) != 0) {
        return false;
      }
      if (sVar3 == 0x11) {
...
bool __cdecl FUN_01008140(int param_1)

{
  ...
  do {
    iVar2 = iVar2 + 1;
    uVar1 = FUN_01007cb0(param_1,3);
    *(char *)(param_1 + 0xe33 + iVar2) = (char)uVar1;
  } while (iVar2 < 8);
  if (*(int *)(param_1 + 0x2ebc) != 0) {
    return false;
  }
  iVar2 = FUN_01008f30(param_1,param_1 + 0xe34,(undefined4 *)(param_1 + 0xdb4));
  return (bool)('\x01' - (iVar2 == 0));
}



int __cdecl FUN_01008190(int *param_1,uint param_2,int param_3)
...
undefined4 __cdecl FUN_01008210(int param_1)
...
int __fastcall
FUN_01008280(undefined4 param_1,undefined4 param_2,int *param_3,uint param_4,int param_5)

{
  ...
  if ((int)param_4 < 0x101) {
    ...
    uVar2 = FUN_010082e0(param_3,param_4,iVar1);
  ...
  uVar3 = FUN_010090c3(param_1,param_2,param_3,param_4,param_5);
  return (int)uVar3;
}



int __cdecl FUN_010082e0(int *param_1,int param_2,int param_3)
...
int __cdecl FUN_01008570(int *param_1,uint param_2,int param_3)
...
int __cdecl FUN_010088f0(int *param_1,uint param_2,int param_3)

{
  ...
  if ((int)param_2 < 0x101) {
    ...
    uVar1 = FUN_01008950(param_1,param_2,iVar2);
  ...
  iVar2 = FUN_01008570(param_1,param_2,param_3);
  return iVar2;
}



int __cdecl FUN_01008950(int *param_1,int param_2,int param_3)
...
undefined8 __fastcall
FUN_01008cac(undefined4 param_1,undefined4 param_2,undefined4 param_3,uint param_4,int param_5,
...
undefined4 __cdecl FUN_01008f30(undefined4 param_1,int param_2,undefined4 *param_3)
...
undefined8 __fastcall
FUN_010090c3(undefined4 param_1,undefined4 param_2,int *param_3,uint param_4,int param_5)
  ...
  do {
    ...
    while( true ) {
      ...
      *(char *)(uVar16 + iVar1) = (char)uVar12;
      puVar14 = (ushort *)param_3[0xac2];
      uVar16 = param_4;
      if (uVar4 <= param_4) goto LAB_01009304;
    }
    uVar13 = uVar12 >> 3;
    uVar12 = uVar12 & 7;
    if (uVar12 == 7) {
    ...
    if ((char)uVar13 < '\x04') {
      ...
      iVar11 = (local_38 >> ((&DAT_01009090)[uVar5] & 0x1f)) + *(int *)(&DAT_01001500 + uVar5 * 4);
...

{
  BOOL BVar1;
                    ...
                    // WARNING: Could not recover jumptable at 0x01009352. Too many branches
...

{
  BOOL BVar1;
                    ...
                    // WARNING: Could not recover jumptable at 0x01009358. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  DWORD DVar1;
                    ...
                    // WARNING: Could not recover jumptable at 0x0100935e. Too many branches
                    // WARNING: Treating indirect jump as call
